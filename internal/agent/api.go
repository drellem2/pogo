...
type SpawnPolecatAPIRequest struct {
	...
	// states why. Same shape and same reasoning as the two above.
	//
	// It has a legitimate use that the other two do not, and the flag exists as
...
func (r *Registry) handleSpawnPolecat(w http.ResponseWriter, req *http.Request) {
	...
	//
	// Overridable, and unlike the two above the override has a use that is not a
	// false positive: an item can legitimately have work after its merge. What
