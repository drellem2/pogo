...
//
// It is the fifth refusal at this chokepoint and the complement of the third.
...
// four beside it, whose nil default is a functional implementation.
//
...
// cmd/pogod wires it unconditionally beside the other four, so whether it
