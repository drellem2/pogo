...
5. **Review through three lenses, in this order.** Each lens produces findings; classify every finding as **blocking** or **advisory** (a nit you explicitly mark non-blocking).
   ...
   1. **QA — build and tests actually run.** Never verdict from reading alone:
      ...
      - **Evidence discipline — five habits, one idea: a claim about your own work is worth what it cost to make.** None is a gate; they change what you write down before you look.
        ...
        - **Credit an effect to one of two causes only from a family holding the other LITERALLY constant, and report the invariant.** Two artifacts differing in many ways cannot say which difference carried the effect. mg-db09 ran TL_n(β) at β=3,2,1,0 — same multiplicity-free branching, 132 path pairs at n=6 at every β — and the conclusion held at two values, not the other two; unstated, the invariant is taken on trust.
