- **The refinery's network retry budget was 52 seconds against an outage
  ...
  **duration 15m26s**. The refinery's own timeline sits inside that window and
  ...
  merge stays asleep; the test asserts both halves against the 15m26s figure.
  ...
  established tightly enough to schedule against. Duration is, and is stable
  across four waves.
  ...
  **What is NOT claimed.** Nothing here predicts when the next window opens, and
  ...
  measured against a *future* outage — it is sized against the one that was
  measured, with a 6m19s margin; an outage materially longer than 15m26s would
  still exhaust it, and the mail now says so in a way a reader can check. A held
